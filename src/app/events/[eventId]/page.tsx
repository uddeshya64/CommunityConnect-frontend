...
export default function EventDetailsPage() {
    ...
    const fetchEvent = async () => {
      try {
        ...
        setEditData({
          ...
          category: rawEvent.type || rawEvent.category || "meetup", mode: rawEvent.mode || "offline",
  ...
  const handleUpdate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await eventService.updateEvent(eventId, editData);
      setUpdateMessage({ type: "success", text: "Event updated successfully!" });
    } catch (err: any) {
      setUpdateMessage({ type: "error", text: "Failed to update event." });
