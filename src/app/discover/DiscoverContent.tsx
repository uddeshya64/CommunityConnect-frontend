      ...
      <AppLayout>
        <div className="flex-1 relative overflow-hidden pb-20 min-w-0">
          ...
          <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 relative z-10 w-full min-w-0 overflow-x-hidden">
            ...
            <div
              className={`rounded-3xl border mb-8 transition-all duration-300 overflow-hidden ${isDark
              ...
              <div className="p-5 sm:p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div className="space-y-3 flex-1">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    {/* Location Badge */}
                    <span
                      className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-bold ${isDark
                    ...
                    {userSkills.map((skill) => (
                      ...
                      >
                        ...
                        <button
                          ...
                          className={`w-4 h-4 rounded-full flex items-center justify-center transition-colors ml-0.5 ${isDark ? "hover:bg-white/15 text-indigo-200" : "hover:bg-indigo-200 text-indigo-900"
                            }`}
                          title={`Remove ${skill}`}
                        >
                ...
                <div className="flex items-center gap-2 shrink-0 w-full sm:w-auto">
                  <Button
                    ...
                    className={`w-full sm:w-auto rounded-2xl font-extrabold text-xs px-4 py-2.5 flex items-center justify-center sm:justify-start gap-2 transition-all cursor-pointer ${isCustomizerOpen
                      ? isDark
              ...
              <AnimatePresence>
                {isCustomizerOpen && (
                  <motion.div
                    ...
                    className={`border-t p-5 sm:p-7 space-y-6 ${isDark
                  ...
                  >
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
                      ...
                      <div
                        className={`lg:col-span-7 rounded-2xl p-5 border space-y-4 shadow-xs ${isDark
                      ...
                      >
                        ...
                        <div className="flex gap-2">
                          <Input
                            ...
                            className={`rounded-xl text-xs font-bold ${isDark
                          ...
                          <div className="flex flex-wrap gap-1.5">
                            {BASE_TOPICS_POOL.filter(
                              ...
                              <button
                                ...
                                className={`px-3 py-1 rounded-xl text-xs font-bold border transition-all cursor-pointer flex items-center gap-1 ${isDark
                      ...
                      <div
                        className={`lg:col-span-5 rounded-2xl p-5 border space-y-4 shadow-xs ${isDark
                          ? "bg-zinc-900/90 border-zinc-800"
                          : "bg-white border-zinc-200"
                          }`}
                      >
                            ...
                            {["Global", "San Francisco, CA", "Bengaluru, India", "New York, NY", "London, UK"].map(
                              (preset) => (
                                <button
                                  ...
                                  className={`px-3 py-1 rounded-xl text-xs font-bold border transition-all cursor-pointer ${preferences.defaultCity === preset
                    ...
                    <div
                      className={`rounded-2xl p-5 border space-y-4 shadow-xs ${isDark
                        ? "bg-zinc-900/90 border-zinc-800"
                        : "bg-white border-zinc-200"
                        }`}
                    >
                        ...
                        {dynamicCategories.map((cat) => {
                          ...
                          return (
                            <button
                              ...
                              className={`px-3.5 py-2 rounded-xl text-xs font-extrabold transition-all flex items-center gap-2 cursor-pointer border ${isFav
                                ? `bg-gradient-to-r ${activeAccent.gradient} text-white border-transparent shadow-xs`
                                : isDark
                                  ? "bg-zinc-800/90 border-zinc-700 text-zinc-100 hover:border-zinc-500 hover:bg-zinc-750"
                                  : "bg-zinc-100 border-zinc-300 text-zinc-900 hover:border-zinc-400 hover:bg-zinc-200"
                          ...
                          <div className="p-5 flex-1 flex flex-col">
                            <div className="flex items-start justify-between gap-3 mb-3">
                              ...
                              <button
                                ...
                                className={`p-2 shrink-0 rounded-full transition-all ${event.is_saved
